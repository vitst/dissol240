...
class OneBumpInZ(gbm.AbstractBaseGenerator):
  '''
  This is the generator for the flat fracture with two waves in Z direction
  It is an asymmetric case where the bump is on one wall and directed inside of the fracture.
  '''

  def __init__(self):
    self.__genName__ = 'oneBump'
